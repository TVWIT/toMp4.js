// H.264 CABAC context initialization tables
// Source: FFmpeg libavcodec/h264_cabac.c (LGPL 2.1+)
// Derived from ITU-T H.264 spec Tables 9-12 through 9-23
//
// Each entry is [m, n] where:
//   preCtxState = Clip3(1, 126, ((m * SliceQPy) >> 4) + n)
//   valMPS = (preCtxState > 63) ? 1 : 0
//   pStateIdx = (preCtxState > 63) ? preCtxState - 64 : 63 - preCtxState
//
// 1024 entries per table (contexts 0-459 are spec-defined,
// 460-1023 are High Profile / 8x8 transform extensions)

/**
 * I-slice CABAC context init values [1024][m, n]
 */
...
/**
 * P/B-slice CABAC context init values [3][1024][m, n]
 * Indexed by cabac_init_idc (0, 1, or 2)
 */
export const cabacInitPB = [
  // cabac_init_idc = 0
  [
    [20,-15], [2,54], [3,74], [20,-15], [2,54], [3,74], [-28,127], [-23,104],
